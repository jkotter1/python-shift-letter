...
# __________________Main Form Code__________________
class NightLetterMain(QtWidgets.QMainWindow):
    ...
    def eventFilter(self, source, event):
        ...
        #print(event.type())
        #if source is application.ui.Date and event.type() == QtCore.QEvent.mousePressEvent: #QMouseEvent.mousePressEvent and :
        #    application.datePicker()
        #if source is application.ui. and event.type() == QtCore.QEvent.FocusIn:

        #if source is application.ui.Date and event.type() == QtCore.QEvent.FocusIn:
        #    print("Focus on Date")
        #    print(self.ui.OpenDateDiag)
    ...
    def datePicker(self, obj):
        #self.ui.OpenDateDiag = False
        #print("OpenDateDiag is " + str(self.ui.OpenDateDiag))
