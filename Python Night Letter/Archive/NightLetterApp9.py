...
class mywindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.ui.Attachments.clicked.connect(lambda: self.attach_document(self.openFileNameDialog()))
        self.ui.AttachmentList.anchorClicked.connect(self.linkClicked)

    def linkClicked(self, url):
        linkPath = "\"" + url.toString().replace("%5C", "/") + "\""
        #QtGui.QDesktopServices.openUrl(linkPath)
        print(linkPath)
        #process = subprocess.Popen(['echo', linkPath],
    ...
    def attach_document(self, docPath):
        ...
        self.ui.AttachmentList.append(fileLink)
        #print(docPath)
